...
class dingdan extends admin {
	...
	public function __construct(){		
		...
		$this->ment=array(
						...
						array("lists","已填地址",ROUTE_M.'/'.ROUTE_C."/lists/yitian"),
	...
	public function zhongjiang(){
		...
		$recordlist=$this->db->GetPage("select * from `@#_member_go_record`,`@#_member` where `@#_member_go_record`.uid=`@#_member`.uid and `@#_member`.auto_user=0 and `@#_member_go_record`.huode !='0' order by `@#_member_go_record`.time DESC ",array("num"=>$num,"page"=>$pagenum,"type"=>1,"cache"=>0));	
